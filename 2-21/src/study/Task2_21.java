...
public class Task2_21 {
    ...
    public static void main(String[] args) {
        ...
        // 変数orange、、apple、pearの値を順に格納して下さい。
        ArrayList<String> fgraperuitsArrayList = new ArrayList<>();
        fgraperuitsArrayList.add("orange");
        fgraperuitsArrayList.add("grape");
        fgraperuitsArrayList.add("apple");
        fgraperuitsArrayList.add("pear");
        ...
        for(String fruits: fruitsHashMap.keySet()) {
            System.out.println( fruits + "の値は" + fruitsHashMap.get(fruits)+"です");
    }
         }
