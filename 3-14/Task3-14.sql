...
FROM goods_table WHERE price >= 20000;
...
SELECT store_table.store_name, goods_table.goods_name, stock_table.quantity
FROM stock_table
...
SELECT goods_code, goods_name, price, update_day
FROM goods_table
